/* Да се дефинира апстрактна класа Vehicle.
Од неа се изведуваат Car и Jet со користење на виртуелно наследување (virtual public Vehicle).
Класата JetCar наследува и од Car и од Jet.
Благодарение на виртуелното наследување, JetCar има само една копија од manufacturer и speed. */
